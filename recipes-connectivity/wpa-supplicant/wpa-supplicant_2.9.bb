...
FILES:${PN}-passphrase += "${base_bindir}/wpa_passphrase"
FILES:${PN}-cli += "${base_sbindir}/wpa_cli"
...
do_install () {
    ...
    install -m 0644 ${UNPACKDIR}/99_wpa_supplicant ${D}${sysconfdir}/default/volatiles
}
