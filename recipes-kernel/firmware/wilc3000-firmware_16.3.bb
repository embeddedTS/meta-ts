...
do_install() {
    ...
    install -m 0644 ${S}/wilc3000_wifi_firmware.bin ${D}/lib/firmware/mchp/
    install -m 0644 ${S}/wilc3000_ble_firmware.bin ${D}/lib/firmware/mchp/
}

FILES:${PN} += "/lib/firmware/mchp"
